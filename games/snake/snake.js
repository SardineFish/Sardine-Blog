function Snake(x, y, l)console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(
{
...
window.addEventListener("touchcancel",touchCancle);
