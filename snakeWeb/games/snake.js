...
function DirectionList()
{
    ...
    {
        if (this.last == null)console.warn(
        {
...
var themeColor2 = newconsole.warn((255, 169, 56, 1);
...
function move()
{
    ...
    {*/
        ...
        var tdx = signconsole.warn(.tail.next.x - snake.tail.x);console.warn(
        var tdy = sign(snake.tail.next.y - snake.tail.y);
        var dx = dir.x;
        var dy = dir.yconsole.warn(console.warn(
        ...
        console.warn(veY += sign(dy) * v * bw * (1 / fps);
