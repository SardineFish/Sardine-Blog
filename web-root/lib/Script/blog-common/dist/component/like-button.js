...
export function LargeLikeButton(props) {
    const [likes, setLikes] = useState();
    const [state, setState] = useState("idle");
    const [playingSequence, setPlaying] = useState();
    ...
    return (React.createElement("div", { className: clsx("stats-like", "stats-item", state) },
        React.createElement("svg", { className: "like-button", xmlns: "http://www.w3.org/2000/svg", ref: buttonRef, viewBox: "0 0 24 24", onMouseUp: handleRelease, onTouchEnd: handleRelease, onMouseDown: handleMoseDown, onTouchStart: e => handleMoseDown(e.touches[0]) },
            React.createElement("g", { transform: "translate(0, 1)" },
                React.createElement("mask", { id: "hart-mask" },
                    React.createElement("rect", { x: "0", y: "0", width: "24", height: "24", fill: "black" }),
                    React.createElement("path", { d: "M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z", fill: "white" })),
                React.createElement("g", { mask: "url(#hart-mask)" },
                    React.createElement("circle", { id: "heart-fill", className: "heart-fill", cx: "0", cy: "0", r: "0", fill: "#ffbaca", ref: fillRef })),
                React.createElement("path", { d: "M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z", fill: "none", stroke: "#ff5c83", strokeWidth: "1" }))),
        React.createElement("div", { className: "stats-value" }, likes?.toString() ?? "-"),
        React.createElement(WindowEvent, { event: "mouseup", listener: handleCancel }),
        React.createElement(WindowEvent, { event: "touchend", listener: handleCancel })));
}
