            ...
            <div className="comment-system">
                ...
                {comments === null
                    ...
                    : <ul className="comment-area">
                        {
                            comments.sort(sortTimeDesc)
                                .map((c, idx) => (<CommentRenderer key={idx} comment={c} level={0} levelLimit={levelLimit} />))
                        }
                    </ul>
                }
            </div>
...
function sortTimeDesc(a: Comment, b: Comment)
{
...
function PostComment(props: { cid: number, onPost?: () => void })
{
    ...
    return (
        <div className="post-area">
            ...
            <div className={clsx("comment-poster", { "show": postVisible }, { "hide": !postVisible })} onClick={backgroundClick}>
...
function urlDefault(url: string | null)
{
    if (!url || /^\s*$/.test(url))
        return "#";
    if (!/^https?:\/\//i.test(url))
