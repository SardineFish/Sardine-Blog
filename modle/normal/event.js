...
function menuButtonMouseOver(e)
{
    if (e.target)
    {
        ...
        var tx = button.offset().left - $("#topMenuButtonContainer").offset().left;
        menuSelectOffset = tx;
        $("#menuFocus").stop();
...
function menuButtonMouseOut(e)
{
    if (e.target)
    {
        ...
        var tx = $("#buttonHere").offset().left - $("#topMenuButtonContainer").offset().left;
...
function loaded()
{
    $("#menuFocus").css("left", $("#buttonHere").offset().left - $("#topMenuButtonContainer").offset().left + "px");
    loadUser();
}
