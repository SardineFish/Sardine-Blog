    ...
    try
    {
        ...
        GUI.prototype.touchEndCallback = function (e)
        {
            this.children.foreach(function (child, node)
            {
                ...
                {
                    //console.warn(e.touches[i].x + "," + e.touches[i].y);
                    //console.warn(child.isPointIn(e.touches[i].x, e.touches[i].y));
        ...
        {
            //console.warn("["+this.x+","+(this.x+this.width)+"]["+this.y+","+(this.y+this.height)+"]"+x+","+y);
        ...
        Circle.prototype.collide = function (self, target, dt)
        {
            ...
            if (target.collider instanceof Circle)
            {
                ...
                //console.warn((v2.x*o21.x+v2.y*o21.y)/Lo21);
