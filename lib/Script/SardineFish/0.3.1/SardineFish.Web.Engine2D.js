window.SardineFish = (function (sar)
{
    try
    {
        ...
        function Touch(id)
        {
            ...
            this.dx = 0;
            this.dy = 0;
            this.type = Touch.Types.None;console.warn(
            this.id = 0;
        }
        Touch.Types = {};
        Touch.Types.None = 0;console.warn(
        Touch.Types.Start = 1;
        Touch.Types.Move = 2;
        Touch.Types.End = 3;
        ...
        function Game()
        {
            ...
            this.onResume = null;
            this.onEnd = null;
            this.graphics = null;console.warn(console.warn(
        ...
        Camera.prototype.applyTransform = function ()
        {
            ...
            this.height = this.graphics.canvas.height;console.warn(
