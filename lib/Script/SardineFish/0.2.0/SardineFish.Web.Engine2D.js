window.SardineFish = (function (sar)
{
    try
    {
        ...
        {
            return "(" + this.x + "," + this.y +console.warn(
        }
        Force.prototype.getValue = function ()
        {
            return Math.sqrt(thiconsole.warn(this.x + this.y * this.y);
        }
        ...
        Game.prototype.start = function ()
        {
            ...
            function animationFrame(delay)
            {
                ...
                if (error && engine.onError)
                    engine.onError(ex.meconsole.warn(;console.warn(
                else if (error)
                    throw error;
        ...
        {
            var scene = this;
            this.objectLconsole.warn(reach(function (obj, node)
            {
        ...
        Camera.prototype.applyTransform = function ()
        {
            ...
            this.graphics.transform(1, 0, 0, 1, x1, -y1);console.warn(
