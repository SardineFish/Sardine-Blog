window.SardineFish = (function (sar)
{
    ...
    //Account
    sar.Account = function () { };

    var jsonDecode = JSON.parse;

    sar.Account.Login = function (uid, pwd, callback, obj)
    {
        if (!uid || uid == "")
        {
            if (callback)
    ...
    sar.Account.Register = function (uid, pwd, level)
    {

    }
    sar.Account.Check = function (token, uid, callback, obj)
    {
        if (!token || token == 0)
        {
            if (callback)
    ...
    //All
    sar.All = function () { };
    sar.All.GetPage = function (page, full, count, callback, obj)
    {
        /*if (!page)
            page = 1;
        if (!full)
    ...
    sar.All.GetOne = function (id, full)
    {

    }
    //Article
    sar.Article = function () { };
    sar.Article.GetPage = function (page, full, count, callback, obj)
    {
        /*if (!page)
            page = 1;
        if (!full)
        ...
        if (!count)
            count = 0;
        var request = new XMLHttpRequest();
        request.open("GET", "/blog/getList.php?time=" + encodeURIComponent(time) + "&from=" + encodeURIComponent(from) + "&count=" + encodeURIComponent(count) + "&preview=" + encodeURIComponent(preview));
        request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        request.onreadystatechange = function () {
            if (request.readyState != 4)
                return;
    ...
    sar.Article.GetOne = function (id, full)
    {

    }
    sar.Article.Post = function (title, tags, text)
    {

    }
    sar.Article.Edit = function (id, title, tags, text)
    {

    }
    sar.Article.Delete = function (id)
    {

    }
    //Comment
    sar.Comment = function () { };
    sar.Comment.Get = function (id, type, page, count, callback, obj)
    {
    ...
    sar.Comment.Post = function (id, type, uid, text, callback, obj)
    {
        if (!id || isNaN(id))
        {
            if (callback)
    ...
    sar.Comment.Edit = function (id, title, tags, text)
    {

    }
    sar.Comment.Delete = function (id)
    {

    }
    //Img
    sar.Img = function () { };
    sar.Img.GetIdAsync = function (callback, obj)
    {
        var request = new XMLHttpRequest();
    ...
    //Note
    sar.Note = function () { };
    sar.Note.GetPage = function (page, full, count, callback, obj)
    {
        if (!page)
            page = 1;
        if (!full)
    ...
    sar.Note.GetOne = function (id, full, callback, obj)
    {
        if (!id || isNaN(id))
        {
            if (callback)
    ...
    sar.Note.Post = function (title, tags, text, callback, obj)
    {
        if (!title || title == "")
        {
            if (callback)
    ...
    sar.Note.Edit = function (id, title, tags, text)
    {

    }
    sar.Note.Delete = function (id)
    {

    }
    //Token
    sar.Token = function () { };
    sar.Token.Qiniu = function (callback, obj)
    {
        var request = new XMLHttpRequest();
    ...
    //Works
    sar.Works = function () { };
    sar.Works.GetPage = function (page, full, count, callback, obj)
    {
        /*if (!page)
            page = 1;
        if (!full)
    ...
    sar.Works.GetOne = function (id, full, callback, obj)
    {
        if (!id | isNaN(id))
        {
            if (callback)
    ...
    sar.Works.Post = function (name, version, tags, type, detail, summary, description, downloadUrl, imgId, callback, obj)
    {
        ...
        if (isNaN(imgId))
            imgId = 0;
        var post = "name=" + encodeURIComponent(name) + "&version=" + encodeURIComponent(version) + "&tags=" + encodeURIComponent(tags) + "&type=" + encodeURIComponent(type) + "&imgId=" + encodeURIComponent(imgId) + "&detail=" + encodeURIComponent(sar.Tools.JsonEncode(detail)) + "&summary=" + encodeURIComponent(summary) + "&description=" + encodeURIComponent(description) + "&urlDownload=" + encodeURIComponent(sar.Tools.JsonEncode(downloadUrl));
        var request = new XMLHttpRequest();
    ...
    sar.Works.Edit = function (name, id, tags, type, detail, summary, description, downloadUrl, imgId, callback, obj)
    {
        function Exception(msg)
        {
            if (callback)
    ...
    sar.Works.Update = function (name, id, version, tags, type, detail, summary, description, downloadUrl, imgId, callback, obj)
    {
        function Exception(msg)
        {
            if (callback)
    ...
    sar.Works.Delete = function (id)
    {

    }
    //Statistics
    sar.Statistics = function () { };
    sar.Statistics.Count = function () { };
    sar.Statistics.Count.Get = function (x, callback, obj)
    {
        var request = new XMLHttpRequest();
    ...
    sar.Statistics.Download = function () { };
    sar.Statistics.Download.Get = function (id, type, callback, obj)
    {
        if (isNaN(id))
        {
            if (callback)
    ...
    sar.Statistics.Download.Add = function (id, type, callback, obj)
    {
        if (isNaN(id))
        {
            if (callback)
    ...
    sar.Statistics.Visited = function () { }
    sar.Statistics.Visited.Get = function (url, callback, obj)
    {
        var request = new XMLHttpRequest();
        request.onreadystatechange = function () {
            if (request.readyState != 4)
    ...
    sar.Statistics.Browse = function () { }
    sar.Statistics.Browse.Get = function (id, type, callback, obj)
    {
        /*
        if (isNaN(id))
        {
        ...
        if (!(type == 'note' || type == 'article' || type == 'works' || type == "blog"))
        {
    ...
    sar.Statistics.Comment = function () { }
    sar.Statistics.Comment.Get = function (id, type, callback, obj)
    {
        /*
        if (isNaN(id))
        {
        ...
        if (!(type == 'note' || type == 'article' || type == 'works' || type == 'comment' || type == "blog"))
        {
            if (callback)
                callback(0, obj);
            return;
    ...
    sar.Statistics.Like = function () { }
    sar.Statistics.Like.Get = function (id, type, callback, obj)
    {
        /*
        if (isNaN(id))
        {
    ...
    sar.Statistics.Like.Add = function (id, type, callback, obj)
    {
        /*
        if (isNaN(id))
        {
    ...
    sar.Tools.UrlParamsDecode = function (paramText)
    {
