var SardineFish = (function (sar)
{
    if (!sar)
        sar = function () { }

    //Account
    SardineFish.Account = function () { };
    SardineFish.Account.Login = function (uid, pwd, callback, obj)
    {
        if (!uid || uid == "")
        {
            if (callback)
        ...
        pwd = SardineFish.Tools.SHA1(pwd);
        ...
        request.onreadystatechange = function ()
        {
            ...
            var response = SardineFish.Tools.JsonDecode(json);
    ...
    SardineFish.Account.Register = function (uid, pwd, level)
    {

    }
    SardineFish.Account.Check = function (token, uid, callback, obj)
    {
        if (!token || token == 0)
        {
            if (callback)
    ...
    //All
    SardineFish.All = function () { };
    SardineFish.All.GetPage = function (page, full, count, callback, obj)
    {
        if (!page)
            page = 1;
        if (!full)
        ...
        if (!count)
            count = 10;
        var request = new XMLHttpRequest();
        request.open("GET", "/all/get.php?page=" + page.toString() + "&full=" + full.toString() + "&count=" + count.toString());
        request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        request.onreadystatechange = function ()
        {
            if (request.readyState != 4)
    ...
    SardineFish.All.GetOne = function (id, full)
    {

    }
    //Article
    SardineFish.Article = function () { };
    SardineFish.Article.GetPage = function (page, full, count, callback, obj)
    {
        if (!page)
            page = 1;
        if (!full)
    ...
    SardineFish.Article.GetOne = function (id, full)
    {

    }
    SardineFish.Article.Post = function (title, tags, text)
    {

    }
    SardineFish.Article.Edit = function (id, title, tags, text)
    {

    }
    SardineFish.Article.Delete = function (id)
    {

    }
    //Comment
    SardineFish.Comment = function () { };
    SardineFish.Comment.Get = function (id, type, page, count, callback, obj)
    {
        ...
        request.open("GET", "/comment/get.php?id=" + encodeURIComponent(id.toString()) + "&type=" + encodeURIComponent(type) + "&page=" + encodeURIComponent(page.toString()) + "&count=" + encodeURIComponent(count.toString()), true);
        request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        request.send();
    }
    SardineFish.Comment.Post = function (id, type, uid, text, callback, obj)
    {
        if (!id || isNaN(id))
        {
            if (callback)
        ...
        if (!(type == 'note' || type == 'works' || type == 'article' || type == 'comment'))
        {
            if (callback)
        ...
        var post = "id=" + encodeURIComponent(id.toString()) + "&type=" + encodeURIComponent(type) + "&uid=" + encodeURIComponent(uid) + "&text=" + encodeURIComponent(text);
        var request = new XMLHttpRequest();
        request.onreadystatechange = function ()
        {
            if (request.readyState != 4)
    ...
    SardineFish.Comment.Edit = function (id, title, tags, text)
    {

    }
    SardineFish.Comment.Delete = function (id)
    {

    }
    //Img
    SardineFish.Img = function () { };
    SardineFish.Img.GetIdAsync = function (callback, obj)
    {
        var request = new XMLHttpRequest();
    ...
    SardineFish.Img.GetId = function ()
    {
        var request = new XMLHttpRequest();
    ...
    //Note
    SardineFish.Note = function () { };
    SardineFish.Note.GetPage = function (page, full, count, callback, obj)
    {
        if (!page)
            page = 1;
        if (!full)
        ...
        if (!count)
            count = 10;
        var request = new XMLHttpRequest();
        request.open("GET", "/note/get.php?page=" + page.toString() + "&full=" + full.toString() + "&count=" + count.toString());
        request.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
        request.onreadystatechange = function ()
        {
            try
    ...
    SardineFish.Note.GetOne = function (id, full, callback, obj)
    {
        if (!id || isNaN(id))
        {
            if (callback)
    ...
    SardineFish.Note.Post = function (title, tags, text, callback, obj)
    {
        if (!title || title == "")
        {
            if (callback)
                callback(false, "标题不能为空.", obj);
            return;
        }
        if (!tags || tags == "")
        {
            if (callback)
                callback(false, "标签不能为空.", obj);
            return;
        }
        if (!text || text == "")
        {
        ...
        request.onreadystatechange = function ()
        {
            ...
            {
                if (callback)
                    callback(false, "发布失败." + response.msg, obj);
                return;
            }
            if (callback)
                callback(true, response.msg, obj);
    ...
    SardineFish.Note.Edit = function (id, title, tags, text)
    {

    }
    SardineFish.Note.Delete = function (id)
    {

    }
    //Token
    SardineFish.Token = function () { };
    SardineFish.Token.Qiniu = function (callback, obj)
    {
        var request = new XMLHttpRequest();
    ...
    //Works
    SardineFish.Works = function () { };
    SardineFish.Works.GetPage = function (page, full, count, callback, obj)
    {
        if (!page)
            page = 1;
        if (!full)
    ...
    SardineFish.Works.GetOne = function (id, full, callback, obj)
    {
        if (!id | isNaN(id))
        {
            if (callback)
    ...
    SardineFish.Works.Post = function (name, version, tags, type, detail, summary, description, downloadUrl, imgId, callback, obj)
    {
        ...
        if (isNaN(imgId))
            imgId = 0;
        var post = "name=" + encodeURIComponent(name) + "&version=" + encodeURIComponent(version) + "&tags=" + encodeURIComponent(tags) + "&type=" + encodeURIComponent(type) + "&imgId=" + encodeURIComponent(imgId) + "&detail=" + encodeURIComponent(SardineFish.Tools.JsonEncode(detail)) + "&summary=" + encodeURIComponent(summary) + "&description=" + encodeURIComponent(description) + "&urlDownload=" + encodeURIComponent(SardineFish.Tools.JsonEncode(downloadUrl));
        var request = new XMLHttpRequest();
    ...
    SardineFish.Works.Edit = function (name, id, tags, type, detail, summary, description, downloadUrl, imgId, callback, obj)
    {
        function Exception(msg)
        {
            if (callback)
    ...
    SardineFish.Works.Update = function (name, id, version, tags, type, detail, summary, description, downloadUrl, imgId, callback, obj)
    {
        function Exception(msg)
        {
            if (callback)
    ...
    SardineFish.Works.Delete = function (id)
    {

    }
    //Statistics
    SardineFish.Statistics = function () { };
    SardineFish.Statistics.Count = function () { };
    SardineFish.Statistics.Count.Get = function (x, callback, obj)
    {
        var request = new XMLHttpRequest();
    ...
    SardineFish.Statistics.Download = function () { };
    SardineFish.Statistics.Download.Get = function (id, type, callback, obj)
    {
        if (isNaN(id))
        {
            if (callback)
    ...
    SardineFish.Statistics.Download.Add = function (id, type, callback, obj)
    {
        if (isNaN(id))
        {
            if (callback)
    ...
    SardineFish.Statistics.Visited = function () { }
    SardineFish.Statistics.Visited.Get = function (url, callback, obj)
    {
        var request = new XMLHttpRequest();
        request.onreadystatechange = function ()
        {
    ...
    SardineFish.Statistics.Browse = function () { }
    SardineFish.Statistics.Browse.Get = function (id, type, callback, obj)
    {
        if (isNaN(id))
        {
            if (callback)
    ...
    SardineFish.Statistics.Comment = function () { }
    SardineFish.Statistics.Comment.Get = function (id, type, callback, obj)
    {
        if (isNaN(id))
        {
            if (callback)
    ...
    SardineFish.Statistics.Like = function () { }
    SardineFish.Statistics.Like.Get = function (id, type, callback, obj)
    {
        if (isNaN(id))
        {
            if (callback)
    ...
    SardineFish.Statistics.Like.Add = function (id, type, callback, obj)
    {
        if (isNaN(id))
        {
            if (callback)
    ...
    //Tools
    SardineFish.Tools = function () { }
    SardineFish.Tools.JsonDecode = function (json)
    {
        try
        {
            return eval('(' + json + ')');
    ...
    SardineFish.Tools.JsonEncode = function (obj)
    {
        try
        {
    ...
    SardineFish.Tools.SHA1 = function (text)
    {
        function sha1(text)
        {
            function t(c, a, e)
    ...
    SardineFish.Tools.MD5 = function (text)
    {
    ...
    SardineFish.Tools.UrlParamsDecode = function (paramText)
    {
