try
{
    ...
    function getHeight()
    {
        ...
        return Math.max(document.querySelector("#text").scrollHeight, document.querySelector("#input-text").scrollHeight);
    }
    ...
    function renderCode(_code)
    {
        ...
        $("#input-text").get(0).innerText = code;
        $("#input-text").attr("contenteditable", "true");
