window.SardineFish=(function(sar){console.warn(console.warn(console.warn(console.warn(console.warn(console.warn(
try{
    if(!sar)
        sar={};
    ...
    Vector2.prototype.toLine=function(x,y)
    {
        ...
        {
            return new Line(x,new Point(x.x+this.x,x.y+this.y));
        }
    }
...
graphics.drawLine(maxL.p1.x,maxL.p1.y,maxP.x,maxP.y);
            ...
            m1=((I1/R1)+k1*m1)/(1+k1);
            m2=((I2/R2)+k2*m2)/(1+k2);
            v1=Vector2.plus(Vector2.multi(t1,w1*R1),v1);
            v2=Vector2.plus(Vector2.multi(t2,w2*R2),v2);
            var v0=v1;
            v1.minus(v0);
            v2.minus(v0);
            ...
            v2.plus(vt);
            v2.plus(v0);
            var vn1=Vector2.multi(n1,Vector2.multi(v1,n1));
            var vn2=Vector2.multi(n2,Vector2.multi(v2,n2));
            var vt1=Vector2.multi(v1,t1);
            var vt2=Vector2.multi(v2,t2);
            obj1.collider.angV=vt1/R1;
            obj2.collider.angV=vt2/R2;
            obj1.v=vn1;
            obj2.v=vn2;
//alert(v1+","+v2);
